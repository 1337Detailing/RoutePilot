...
final class CompactSpeedometer extends View {
    ...
    void update(Location location){
        ...
        valid=location.hasSpeed()&&location.hasAccuracy()&&location.getAccuracy()<=35&&age>=0&&age<5000000000L;
        speed=Math.max(0,location.getSpeed()*3.6f);fixNanos=location.getElapsedRealtimeNanos();
