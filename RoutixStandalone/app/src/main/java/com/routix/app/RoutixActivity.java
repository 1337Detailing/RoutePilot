...
public class RoutixActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle state){
        ...
        prefs=getSharedPreferences("routix",MODE_PRIVATE);migrateMapPreference();accent=prefs.getInt("accent_color",MAUVE);store=new RouteStore(this,prefs);folderStore=new RouteFolderStore(prefs);hoursStore=new WorkHoursStore(prefs);
